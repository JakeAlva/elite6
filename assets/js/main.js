...
(function(){
  ...
  if(!el) return;
  const wrap = el.querySelector('.aspect-[16/10]');
  const prev = el.querySelector('.prev');
  const next = el.querySelector('.next');
  const dots = el.querySelector('.dots');
  const slides = [
    "assets/images/collage/slide-01.jpg","assets/images/collage/slide-02.png","assets/images/collage/slide-03.jpg",
    "assets/images/collage/slide-04.jpg","assets/images/collage/slide-05.png","assets/images/collage/slide-06.jpg",
    "assets/images/collage/slide-07.jpg","assets/images/collage/slide-08.jpg","assets/images/collage/slide-09.png",
